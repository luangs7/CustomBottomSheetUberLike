...
public class BottomSheetBehaviorUberLike<V extends View> extends CoordinatorLayout.Behavior<V> {
     ...
     */
    public BottomSheetBehaviorUberLike() { }
     ...
     */
    public BottomSheetBehaviorUberLike(Context context, AttributeSet attrs ) {
        super( context, attrs );
...
//            mCallback.onStateChanged(bottomSheet, state);
    ...
    /**
     * A utility function to get the {@link BottomSheetBehaviorUberLike} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link BottomSheetBehaviorUberLike}.
     * @return The {@link BottomSheetBehaviorUberLike} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> BottomSheetBehaviorUberLike<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof BottomSheetBehaviorUberLike)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomSheetBehaviorGoogleMapsLike");
        }
        return (BottomSheetBehaviorUberLike<V>) behavior;
    }
